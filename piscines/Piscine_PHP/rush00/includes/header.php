	...
	<div id="header">
		...
		<div id="gender">
			<table id="gender_table">
				<tr>
					<td class="categories">
						<a href="products_page.php?filtre=tous+les+produits&filtre_ok=OK" title="Tous les produits">TOUS LES PRODUITS</a>
					</td>
					<td class="categories">
						<a href="products_page.php?filtre=femme&filtre_ok=OK" title="Femmes">FEMMES</a>
					</td><td class="categories">
						<a href="products_page.php?filtre=homme&filtre_ok=OK" title="Hommes">HOMMES</a>
					</td>
				</tr>
			</table>
		</div>
