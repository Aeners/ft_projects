...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/06/08 18:53:11 by abrison           #+#    #+#             */
/*   Updated: 2016/06/08 21:20:52 by abrison          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		fill_grp(char *pack, t_group *grp, int *p)
{
	...
	while (++i < 4)
	{
		...
		if (x == 0 && count_shape_id(curr) != 4 && count_shape_id(curr) != 0)
			ft_iserror();
		if (x != 0)
			y++;
	}
